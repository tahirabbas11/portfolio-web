...
export const portfolioData: PortfolioType[] = [
  {
    ...
    description: "A starter project for building RESTful APIs with Node.js, Express, and Mongoose.",
    image: github.src,
  ...
  },
  {
    ...
    description: "An authentication API built with Express.js, designed for secure and efficient user management using JWT.",
    image: github.src,
  ...
  },
  {
    ...
    description: "An NPM package to convert CSV files to JSON format, reading and parsing CSV contents into a JSON array.",
    image: github.src,
  ...
  },
  {
    ...
    description: "An AI-driven project optimizing agricultural processes, funded by IGNITE (https://ignite.org.pk).",
    image: github.src,
    tags: ["AI", "Agriculture", "Automation", "Python", "Machine Learning","fyp"]
  },
  {
    url: "https://github.com/tahirabbas11/Spam-Email-Detection",
    year: 2023,
    title: "Spam Email Detection",
    description: "A project for detecting spam emails using machine learning techniques, analyzing email content to classify messages as spam or not.",
    image: github.src,
  ...
  },
  {
    ...
    description: "A security project comparing file hashes to swiftly detect malicious tampering, ensuring system integrity.",
    image: github.src,
